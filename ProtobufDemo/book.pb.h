...
PROTOBUF_NAMESPACE_OPEN
template<> ::tutorial::Book* Arena::CreateMaybeMessage<::tutorial::Book>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tutorial {
...
class Book PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tutorial.Book) */ {
 public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Book::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Book::id() const {
  // @@protoc_insertion_point(field_get:tutorial.Book.id)
  return _internal_id();
}
inline void Book::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  id_ = value;
}
inline void Book::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline const std::string& Book::name() const {
  // @@protoc_insertion_point(field_get:tutorial.Book.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Book::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
  // @@protoc_insertion_point(field_set:tutorial.Book.name)
}
inline std::string* Book::mutable_name() {
  // @@protoc_insertion_point(field_mutable:tutorial.Book.name)
...
inline std::string* Book::release_name() {
  // @@protoc_insertion_point(field_release:tutorial.Book.name)
...
inline void Book::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:tutorial.Book.name)
}
